...
<html lang="en" ng-app='how2read'>
  <head>
    ...
    <link href="/static/fonts/iconfont.woff?v0.0.2" rel="stylesheet">
    <link href="/static/css/issue.min.css?v0.0.2" rel="stylesheet">
  </head>
  <body>
    @yield('content')

    <script src="http://cdn.bootcss.com/angular.js/1.5.6/angular.min.js"></script>
    <script src="/static/js/issue.min.js?v0.0.2"></script>
  </body>
</html>