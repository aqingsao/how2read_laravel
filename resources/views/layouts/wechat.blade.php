...
<html lang="en" ng-app='how2read'>
  <head>
    ...
    <link href="/static/fonts/iconfont.woff?v0.1.1" rel="stylesheet">
    <link href="/static/css/issue.min.css?v0.1.1" rel="stylesheet">
  </head>
  <body>
  <div style='margin:0 auto;width:0px;height:0px;overflow:hidden;'>
    ...
    <script src="/static/js/issue.min.js?v0.1.1"></script>
  </body>
</html>